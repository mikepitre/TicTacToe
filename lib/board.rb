class Board
  ...
  def player1_selection
    ...
    take_selection = gets.chomp.to_i
      if (take_selection == 1) && (@space1 == 1)
        @space1 = "X"
      elsif (take_selection == 2) && (@space2 == 2)
        @space2 = "X"
      elsif (take_selection == 3) && (@space3 == 3)
        @space3 = "X"
      elsif (take_selection == 4) && (@space4 == 4)
        @space4 = "X"
      elsif (take_selection == 5) && (@space5 == 5)
        @space5 = "X"
      elsif (take_selection == 6) && (@space6 == 6)
        @space6 = "X"
      elsif (take_selection == 7) && (@space7 == 7)
        @space7 = "X"
      elsif (take_selection == 8) && (@space8 == 8)
        @space8 = "X"
      elsif (take_selection == 9) && (@space9 == 9)
        @space9 = "X"
      else
